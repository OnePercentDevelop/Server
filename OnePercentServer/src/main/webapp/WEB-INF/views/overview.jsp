...
<body>
<input type='hidden' id='vote_date' name='vote_date' value='2016년11월03일'>
	<div class="wrapper">
						...
						<div class="col-lg-4 col-sm-6">
							<div class="card">
								<div class="content">
									...
									<h6 class="big-title">일주일 간<span class="text-muted"></span>회원가입 수<span class="text-muted"></span></h6>
