					...
					<li class="active"><a data-toggle="collapse"
						...
						<div class="collapse in" id="tablesExamples">
							<ul class="nav">
								...
								<li class="active"><a href="<%=server %>/questionList.do">질문지 목록</a></li>
							</ul>
						</div></li>
								...
								<div class="content">
									...
									<table id="bootstrap-table" class="table">
										<thead>
											...
											<th data-field="id" class="text-center" data-sortable="true">날짜</th>
											<th data-field="name" data-sortable="true">문제</th>
											<th data-field="salary" data-sortable="true">보기</th>
											<th data-field="country" data-sortable="true">보기 별 선택한 사람 수</th>
											<th data-field="total" data-sortable="true">참가자/당첨자</th>
										...
										<tbody>
											<c:choose>
												<c:when test="${fn:length(question_list) > 0}">
													<c:forEach items="${question_list}" var="row">
														<tr>
															<td></td>
															<td>${row.vote_date}</td>
															<td>${row.vote_question}</td>
															<td>${row.ex1_value}/${row.ex2_value}/${row.ex3_value}/${row.ex4_value}</td>
															<td>${row.ex1_count}/${row.ex2_count}/${row.ex3_count}/${row.ex4_count}</td>
															<td>${row.total_count}/${row.prize_count}</td>
															<td></td>
															<td></td>
														</tr>
													</c:forEach>
...
<script src="resources/common/dashboard/assets/js/question-table.js?ver=1" charset="utf-8"></script>
